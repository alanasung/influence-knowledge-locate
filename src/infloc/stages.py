"""Experiment stages for Locating Factual Knowledge With Influence Functions."""
...
from .infloc._util import ensure_dir, stage_result, write_json
...
def stage_report(cfg: DictConfig, run_dir: Path) -> dict[str, Any]:
    ...
    write_json(
        out / "report.json",
        {"headline": "Locating Factual Knowledge With Influence Functions", "claims_gated": True},
    )
