...
def _registered_builder(name: str):
    ...
    try:
        module = importlib.import_module("infloc.data")
...
def main(argv: list[str] | None = None) -> int:
    ...
    from infloc.utils.run_manifest import utc_now_iso, write_json_atomic
    ...
    if builder is not None:
        ...
        source = f"infloc.data.BUILDERS[{data.name!r}]"
        ...
        print(
            ...
            "src/infloc/data/__init__.py under BUILDERS, or use data=synthetic "
