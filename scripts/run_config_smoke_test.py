...
def _compose(preset: str | None, overrides: list[str]):
    from infloc.configs.loader import load_config
...
def _smoke_one(preset: str | None, args: argparse.Namespace) -> int:
    from infloc.configs.loader import save_resolved_config
    from infloc.utils.git import git_state
...
def main(argv: list[str] | None = None) -> int:
    ...
    from infloc.configs.loader import available_presets
