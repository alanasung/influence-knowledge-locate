...
from infloc.configs.loader import register_schema
...
def _load_stage_registry(package: str = "infloc") -> dict:
...
def _run_stages(cfg: DictConfig, run_dir: Path) -> dict:
    ...
    if unavailable:
        ...
        print(f"      in infloc.stages: {unavailable}")
...
def main(cfg: DictConfig) -> None:
    ...
    from infloc.configs.loader import config_to_dict, save_resolved_config
    from infloc.models.device import get_device
    from infloc.utils.logging import configure_logging
    from infloc.utils.reproducibility import set_seed
    from infloc.utils.run_manifest import create_run_dir, save_run_metadata
